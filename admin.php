				...
				<div class="content col-md-8">
					...
					<section id="bugs">
						...
						<ol>
							...
							<li>
								<span>Una persona con acceso no puede acceder:</span> puede ser producto de un mal tipado en el email de la persona autorizada 
								o pérdida de conexión al actualizar la lista de administradores, similar a lo que sucede 
								con las propiedades en el primer punto.
							</li>
						</ol>
					</section>
				</div>
